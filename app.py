...
# Ваш НОВЫЙ API ключ
genai.configure(api_key="AIzaSyDRjQuN5f3ajl4-lLkuKpviP6X0NkPhjhU")
...
def fetch_available_models():
    ...
    try:
        ...
        for m in genai.list_models():
            ...
            if 'generateContent' in m.supported_generation_methods:
                ...
                if 'gemini' in m.name.lower():
                    # Убираем техническую приставку 'models/'
        ...
        return ["gemini-2.5-pro", "gemini-1.5-pro", "gemini-1.5-flash"] # Резервный вариант
...
if uploaded_file and st.button("Начать распознавание"):
    ...
    for i in range(0, total_pages, chunk_size):
        ...
        # Пауза в 4 секунды между запросами для стабильной работы
        time.sleep(4) 
