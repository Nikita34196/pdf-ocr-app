...
st.write("Загрузите документ, настройте параметры и скачайте готовый Word-файл.")
    ...
    for i in range(0, total_pages, chunk_size):
        ...
        try:
            ...
            if "finish_reason is 4" in error_msg or "RECITATION" in error_msg:
                st.warning(f"⚠️ Страницы {i+1}-{end_page}: Защита всё ещё сработала.")
                full_text += f"\n\n[ ТЕКСТ НА СТРАНИЦАХ {i+1}-{end_page} СКРЫТ ]\n\n"
            else:
